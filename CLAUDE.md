...
Binary lands at `target/release/peekpdf.exe`. Optimized for size (~2 MB) via LTO, panic=abort. Symbols are NOT stripped (`strip = "none"`) — needed for crash diagnostics.
